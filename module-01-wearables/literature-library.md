...
| Validation of nocturnal resting heart rate and heart rate variability in consumer wearables | Dial MB, Hollander ME, Vatne EA, Emerson AM, Edwards NA, Hagen JA. | *Physiological Reports* 2025;13(16):e70527 | [10.14814/phy2.70527](https://doi.org/10.14814/phy2.70527) | C (Corroborated) | **Verified OA** (Physiological Reports is OA by default) | [literature/oura/2025-dial-physiologicalreports-nocturnal-rhr-hrv-validation.pdf](literature/oura/2025-dial-physiologicalreports-nocturnal-rhr-hrv-validation.pdf) — resolves the prior 403/CAPTCHA access block noted in `research-library-wearables.md`; **full-text extraction into `validation-evidence.md` is still an open action item** |
