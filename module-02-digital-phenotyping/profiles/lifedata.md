...
|---|---|---|---|---|---|
| GPS / location | Yes | Yes | Raw point captured alongside a survey response. | No | Captured only when a survey is answered, not continuously. |
| Accelerometer | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Gyroscope | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Magnetometer | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Barometer | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Ambient light | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Proximity | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Device motion / activity recognition | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Screen state | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| App usage | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Battery / charging | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Network / connectivity | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Wi-Fi | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Bluetooth | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Calls (metadata) | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| SMS (metadata) | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Keyboard | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Audio / microphone | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Notifications | No | No | Not applicable | Not applicable | Not a LifeData stream. |
| Device information | No | No | Not applicable | Not applicable | Not a LifeData stream. |

**Verification.** The Module 2 profile records that location captured with a survey answer is the platform's only background stream. Every other row is No by the platform's own scope.

### Notes from earlier verification passes

- Not verified in any pass to date. See the shared table convention in `../../shared/profile-table-conventions.md`.
...
- Marketing/blog content is **stale**: the WordPress post sitemap's most recent `lastmod` is **2024-07-30**, and much of the blog is 2018 to 2019 literature roundups. This is a stale-content signal, not an abandonment signal, see below.
...
- **Maintenance-status verdict: Active, with a stale-marketing caveat.** Evidence for: four app-store listings updated between **April and August 2026**; a website rebuilt in **2026** (Elementor asset timestamps, © 2026); a **new platform generation shipped in 2025 to 2026**; a staffed team page listing five engineers, a principal designer and a CEO; a publications list carrying 26 entries from 2026. Evidence against: a **blog dead since July 2024** and a **broken internal link**, the footer "Products" link points at `?page_id=23768`, which returns the site's 404 page. The broken link and stale blog are cosmetic-website neglect, not product abandonment; the product-side signals are unambiguous.
...
- **Customer publications list (~260 entries, 2016 to 2026)**: https://www.lifedatacorp.com/customer-publications/
...
10. LifeData, Customer Publications. https://www.lifedatacorp.com/customer-publications/ (**direct fetch**, 2026-09-02). **Primary.** ~260 listed publications, 2016 to 2026, including 26 dated 2026, evidence the list is actively maintained.
