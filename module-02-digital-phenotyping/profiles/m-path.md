...
|---|---|---|---|---|---|
| GPS / location | Yes | Yes | Unclear | Unclear | Named for m-Path sense. |
...
| Device motion / activity recognition | Yes | Yes | Derived. Pedometer and activity. | Unclear | Named. |
...
| Bluetooth | Yes | Yes | Derived. Proximity and social-context signals. | Unclear | Named. |
...
| Audio / microphone | Yes | Yes | Derived. Noise and environmental context. | Unclear | Named in general framing only. |
...
**Verification.** Reported from the vendor's own m-Path sense materials. The manual's sensor sub-pages were not reached, so sampling configurability and per-platform parity are Unclear. Niemeijer 2023 (Module 3) reports a 52 iOS and 52 Android performance study on the CARP-based m-Path Sense app.
...
| Essential | €1,599, €2,958 (scales with participant count) | 300 to 600 | Advanced data export, automatic scheduler, participant management |
| Standard | €2,099, €3,616 | 300 to 600 | + priority email support, unlimited projects/accounts, collaboration, add-on selection |
| Comfort | €3,099, €5,338 | 300 to 600 | + online-meeting support, advanced troubleshooting, yearly workshop, yearly study review |
